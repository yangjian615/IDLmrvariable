...
; PURPOSE:
;+
;   Create a gyrophase distribution from the time-dependent 3D distribution function.
;
; :Categories:
...
;                   Number of gyrophase bins in output distribution. By default, the
...
;
; :Returns:
;       GPD:        Gyrophase distribution function.
;
; :Author:
;    Matthew Argall::
...
;-
;*****************************************************************************************
function MrDist_1D_GPD, dist3D, b, phi, theta, energy, $
NBINS=nBins, $
ORDER=order, $
GYRO_BINS=gyro_bins, $
RADIANS=radians, $
