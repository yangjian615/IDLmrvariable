...
;
; :Keywords:
;       E_RANGE:    in, optional, type=fltarr(2)
;                   Range of `ENERGY` over which to average. By default, the entire
;                       energy range is chosen.
;       GYRO_RANGE: in, optional, type=fltarr(2)
;                   Range of `PHI` over which to average. By default, the entire
;                       energy range is chosen.
;       NE_BINS:    in, optional, type=integer
;                   Number of energy bins in output vector. By default, the original
;                       number of bins is chosen, based on the dimensions of `DIST3D`.
;       NPA_BINS:   in, optional, type=integer
;                   Number of pitch angle bins in output vector. By default, the
...
;                   A named variable to receive the centers of the new pitch angle bins.
...
;
; :Returns:
;       PAD:        Pitch angle distribution function.
;
; :Author:
;    Matthew Argall::
...
;-
;*****************************************************************************************
function MrDist_1D_PAD, dist3D, b, phi, theta, energy, $
E_RANGE=e_range, $
